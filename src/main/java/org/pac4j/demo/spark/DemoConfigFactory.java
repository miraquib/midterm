...
public class DemoConfigFactory implements ConfigFactory {
    ...
    public Config build() {
        ...
        oidcClient.setClientID("696585412393-rb2p7ds756a2tng5h1a30omn0n5l77bp.apps.googleusercontent.com");
        oidcClient.setSecret("9RXbR0dAMLwc2T4v80B3B4dt");
...
*/
        final Clients clients = new Clients("http://localhost:5002/callback", oidcClient /*saml2Client, facebookClient,
